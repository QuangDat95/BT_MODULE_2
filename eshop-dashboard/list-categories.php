...
<div class="content">
    <div class="breadLine">
        <ul class="breadcrumb">
            <li><a href="list-categories.php">Danh mục sách</a></li>
        </ul>
    </div>
    <div class="workplace">
        <div class="row-fluid">        
                ...
                <div class="block-fluid table-sorting">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        ...
                        <tr>
                            ...
                            <th  class="sorting"><a href="#">Tên thể loại Sách</a></th>
                            <th>Hành động</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr> 
                            ...
                            <td>
                            <a href="edit-category.php?id=<?php echo $row->ID_danh_muc;?>" class="btn btn-info">Sửa</a>
                            <a href="delete-category.php?id=<?php echo $row->ID_danh_muc;?>" class="btn btn-info">Xóa</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
