        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="block-fluid table-sorting">
                    <a href="add-user.php" class="btn btn-add">Thêm Sinh viên</a>
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        <thead>
                        <tr>
                            <th><input type="checkbox" id="checkAll"/></th>
                            <th class="sorting"><a href="#">ID Sinh viên</a></th>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="edit-user.php?id=<?php echo $row->ID_Sv;?>" class="btn btn-info">Sửa</a>
                            <a href="delete-user.php?id=<?php echo $row->ID_Sv;?>" class="btn btn-info">Xóa</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
